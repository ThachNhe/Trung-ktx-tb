...
\addcontentsline{toc}{subsubsection}{1.4.4. Phương pháp lập trình và thử nghiệm}
...
\addcontentsline{toc}{subsubsection}{2.3.1. Ca sử dụng 1: Đăng nhập hệ thống}
...
\addcontentsline{toc}{subsubsection}{2.3.2. Ca sử dụng 2: Quản lý phòng}
...
\addcontentsline{toc}{subsubsection}{2.3.3. Ca sử dụng 3: Đặt phòng}
...
\addcontentsline{toc}{subsubsection}{2.3.4. Ca sử dụng 4: Trả phòng}
...
\addcontentsline{toc}{subsubsection}{2.3.5. Ca sử dụng 5: Quản lý dịch vụ}
...
\addcontentsline{toc}{subsubsection}{2.3.6. Ca sử dụng 6: Quản lý sinh viên}
...
\addcontentsline{toc}{subsubsection}{2.3.7. Ca sử dụng 7: Xem báo cáo -- thống kê}
...
\addcontentsline{toc}{subsection}{2.4. Phân tích luồng hoạt động của các ca sử dụng}
...
\addcontentsline{toc}{subsubsection}{2.4.2. Biểu đồ hoạt động cho các ca sử dụng}

\subsubsection*{2.4.2.1. Ca sử dụng: Đặt phòng}
\addcontentsline{toc}{subsubsection}{2.4.2.1. Ca sử dụng: Đặt phòng}
...
\addcontentsline{toc}{subsubsection}{2.4.2.2. Ca sử dụng: Quản lý sinh viên}
...
\addcontentsline{toc}{subsubsection}{2.4.2.3. Ca sử dụng: Quản lý phòng}
...
\addcontentsline{toc}{subsubsection}{2.4.2.4. Ca sử dụng: Thanh toán}
...
\addcontentsline{toc}{subsubsection}{2.4.2.5. Ca sử dụng: Đăng nhập hệ thống}
...
\addcontentsline{toc}{subsubsection}{2.4.2.6. Ca sử dụng: Xem báo cáo thống kê}
...
\subsubsection*{2.4.3. Biểu đồ hoạt động}
\addcontentsline{toc}{section}{2.4.3. Biểu đồ hoạt động}
...
\addcontentsline{toc}{subsubsection}{2.4.3.2. Luồng trạng thái của yêu cầu bảo trì}
...
\addcontentsline{toc}{subsubsection}{2.4.3.3. Luồng trạng thái của phòng ở}
...
\addcontentsline{toc}{subsubsection}{2.4.3.4. Luồng trạng thái của hóa đơn}
...
\addcontentsline{toc}{subsubsection}{2.4.3.5. Luồng trạng thái của phiên đăng nhập}
...
\addcontentsline{toc}{subsubsection}{2.4.3.6. Luồng trạng thái của báo cáo theo tháng}
...
\addcontentsline{toc}{subsection}{2.5. Biểu đồ tuần tự cho các ca sử dụng}

\subsubsection*{2.5.1. Biểu đồ tuần tự đăng nhập hệ thống}
\addcontentsline{toc}{subsubsection}{2.5.1. Biểu đồ tuần tự đăng nhập hệ thống}
...
\addcontentsline{toc}{subsection}{3.1. Biểu đồ triển khai}
...
\addcontentsline{toc}{subsection}{3.2. Kiến trúc hệ thống}

\subsubsection*{3.2.1. Lớp trình diễn}
\addcontentsline{toc}{subsubsection}{3.2.1. Lớp trình diễn}
...
\addcontentsline{toc}{subsubsection}{3.2.2. Lớp xử lí nghiệp vụ}
...
\addcontentsline{toc}{subsubsection}{3.2.3. Lớp dữ liệu}
